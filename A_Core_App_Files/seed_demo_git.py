...
File: seed_demo.py
Purpose:
  - Create/update a "demo" user (example: demo@vestavio.com).
...
def get_db_connection():
    ...
    db_host = os.getenv('DB_HOST', 'insert here')
    db_port = os.getenv('DB_PORT', 'insert here')
    db_user = os.getenv('DB_USER', 'insert here')
    db_password = os.getenv('DB_PASSWORD', 'insert here')
    db_name = os.getenv('DB_NAME', 'insert here')
...
def create_or_get_demo_user(conn):
    demo_email = "your account name"
    demo_password = "your account password"
